...
!(function () {
	if (window.console && window.console.log) {
		...
		e(
			"\n %c JiangWen %c https://jiangwen.site \n",
		...
		localStorage.getItem("hit")
			? (n = Number.parseInt(localStorage.getItem("hit")))
			: localStorage.setItem("hit", 0),
			localStorage.setItem("hit", ++n),
			e(`这是你自 ${t} 以来第 ${n} 次在本站打开控制台，你想知道什么秘密嘛~`);
	}
})();
//# sourceMappingURL=/sm/e285ed9bb98e18fd71a28de1773428d4619037ed3d33652965b65c4c70a6a408.map
